...
export default class DocumentRepository implements IDocumentRepository{
    ...
    async addDocument(documentFile:documentType):Promise<getDocument>{
        try{
            ...
            console.log('error in add document repository :-', err);
			throw new Error('error in add document repository' + err);
        }
    }
    ...
    async getDocumentById(id: string): Promise<getDocument> {
        try{
            ...
            console.log('error in get document repository :-', err);
			throw new Error('error in get document repository' + err);
        }
    }
    ...
    async updateDocument(id: string, document: documentType): Promise<getDocument> {
        try{
            ...
            console.log('error in update document repository :-', err);
			throw new Error('error in update document repository' + err);
        }
    }
    ...
    async deleteDocument(id: string): Promise<getDocument> {
        try{
            ...
            console.log('error in delete document repository :-', err);
			throw new Error('error in delete document repository' + err);
        }
    }
}