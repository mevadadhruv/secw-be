...
roleRouter.post("/createrole", (req, res, next) =>
  roleController.addRole(req, res, next)
);
roleRouter.get("/getrole/:id", (req, res, next) =>
  roleController.getRoleById(req, res, next)
);
roleRouter.get("/getroles", (req, res, next) =>
  roleController.getRoles(req, res, next)
);
roleRouter.put("/updaterole/", (req, res, next) =>
  roleController.updateRole(req, res, next)
);
roleRouter.delete("/deleterole/:id", (req, res, next) =>
